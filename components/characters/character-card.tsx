...
export function CharacterCard({ name, birthYear, films, ships, height, mass, gender }: CharacterCardProps) {
  ...
  return (
    <EntityCard>
      <EntityCard.Header title={name} subtitle={`Nacimiento: ${birthYear}`} badges={badges} />
      <EntityCard.Content>
